  ...
  return (
    <main className='bg-home-mobile bg-cover min-h-screen p-6 pt-[112px] text-center'>
      <div className='text-center flex flex-col gap-4'>
        ...
        <p className='text-design-2 font-barlow text-[15px] text-center leading-7'>Let's face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we'll give you a truly out of this world experience!</p>
      </div>
