  ...
  return (
    <div className='flex flex-col gap-8 md:gap-[49px] items-center text-design-3 px-[97px]'>
      <div className='flex flex-col items-center'>
        ...
        <p className='font-barlow text-[15px] md:text-base text-center mt-[1px] leading-[25px] md:leading-[28px] text-design-2'>The smallest of the four Galilean moons orbiting Jupiter, Europa is a winter lover&apos;s dream. With an icy surface, it&apos;s perfect for a bit of ice skating, curling, hockey, or simple relaxation in your snug wintery cabin.</p>
      </div>
