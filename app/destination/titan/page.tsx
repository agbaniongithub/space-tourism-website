  ...
  return (
    <div className='flex flex-col gap-8 md:gap-[49px] items-center lg:items-start text-design-3 px-[97px] lg:px-0'>
      <div className='flex flex-col items-center lg:items-start'>
        ...
        <p className='font-barlow text-[15px] md:text-base text-center lg:text-left mt-[1px] leading-[25px] md:leading-[28px] text-design-2 max-w-[444px]'>The only moon known to have a dense atmosphere other than Earth, Titan is a home away from home (just a few hundred degrees colder!). As a bonus, you get striking views of the Rings of Saturn.</p>
      </div>
